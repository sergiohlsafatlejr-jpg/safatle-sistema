...
CREATE TABLE `lotesRecurso` (
	...
	`dataEnvio` datetime,
	`dataPrazoPagamento` datetime,
	`dataPrazoResposta` datetime,
...
CREATE TABLE `recebimentos_excel` (
	...
	`data_inicio_faturamento_internacao` datetime,
	`data_fim_faturamento_internacao` datetime,
