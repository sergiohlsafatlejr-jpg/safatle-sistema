...
// ============ DASHBOARD PAGE (exported as default) ============
export default function ConferenciaCorrecaoDashboard() {
...
// ============ DETALHES PAGE (separate export for separate route) ============
export function ConferenciaCorrecaoDetalhes() {
  const [, params] = useRoute("/conferencia-correcao/:snapshotId");
  const snapshotId = parseInt(params?.snapshotId || "0");
  const [, navigate] = useLocation();
  ...
  // Always compute these - never conditionally skip hooks
