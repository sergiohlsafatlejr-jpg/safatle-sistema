    ...
    <div style={{ padding: "24px 32px", maxWidth: 1400, margin: "0 auto" }}>
      ...
      {data && (
        <>
          ...
          {/* Gráfico - Faturado por Mês de Referência */}
          ...
          {/* Gráfico - Projeção por Mês de Vencimento (FILTRADO) */}
          <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #e2e8f0", padding: 24, marginBottom: 24 }}>
          ...
          {/* Drill-down: Detalhe do mês selecionado */}
          {selectedMes && (() => {
            // Encontrar o mês original (YYYY-MM) a partir do label formatado
            const vencConv = data.vencimentoPorConvenio || [];
            // O label está como "Mai/2025", precisamos encontrar qual mes original corresponde
          ...
          {/* Tabela - Detalhamento por Convênio */}
